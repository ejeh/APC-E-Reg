$(document).ready(function () {
  ...
  const data = {
    ...
    KWANDE: {
      "ADIKPO METROPOLIS": [
        ...
        "MECHANIC VILLAGE, MECHANIC VILLAGE ADIKPO",
        "ADIKPO COMP. COLLEGE II, ADIKPO",
        "LOCAL GOVT CLINIC I ADIKPO",
        "IN FRONT OF VIP GUEST HOUSE ADIKPO",
        "OLD B.T.S., OUTSIDE G. KAJO'S HOUSE",
        "ICHEEN CARPENTRY W/SHOP OUTSIDE PREMISES",
        "ITYOATOAKAA COMPOUND, OUTSIDE PREM.",
        "POST OFFICE ADIKPO",
        "TERDOO GUEST INN, OUTSIDE PREMISES",
        "ST ANDREWS SEC SCH I - BTW IKYOR COMP & ST ANDREWS SEC SCH",
        "ELECTRIC OFFICE, OUTSIDE PREMISES",
        "ST ANDREWS SEC SCH II - BTW UJU COMP & ST ANDREWS SEC SCH",
        "LOCAL GOVT CLINIC II ADIKPO - IN FRONT OF THE CLINIC",
        "IKYAAIBO COMPOUND, IN FRONT OF PREMISES",
        "NKST PRIM SCH I ADIKPO - WITHIN SCH PREMISES",
        "LEPROSY CLINIC, OUTSIDE PREMISES",
        "IGBANONGO COMPOUND, OUTSIDE PREMISES",
        "ADANYI BUR JUNCTION, FRONT OF ADANYI'S HOUSE",
        "NKST PRIM SCH II ADIKPO - WITHIN SCH PREMISES",
        "NKST SEC SCH ADIKPO - WITHIN SCH PREMISES",
        "NEW MOTOR PARK, BESIDE ENTRANCE",
        "KAA-ILIEV COMP. I, IN FRONT OF COMPOUND",
        "KAA-ILIEV COMP. II, FRONT OF UMARU'S COMPOUND",
        "TOR SHEEN COMPOUND",
        "GASALA MOTORCYCLE PARK",
        "MAGISTRATE COURT",
        ...
        "ZAKI GBIHI",
        "TAR ABIHYER",
        "LONDON PRIMARY SCHOOL ADIKPO",
        "INFORMATION OFFICE",
        "ADIKPO GARRAGE",
        "IHOM UGU VILLAGE",
        "ZAKI TERKIMBI COMPOUND",
      ],
      "LIEV I": [
        ...
        "NKST PRIM SCH MBANYIM - WITHIN PREMISES",
        ...
        "TSE-AWEN, IN FRONT OF TSE-AWEN COMPOUND",
        "NYAMKWANGE COMPOUND - IN FRONT OF COMPOUND",
        "RCM PRIMARY SCHOOL AGUR",
        "NKST SECONDARY SCHOOL ACHIA",
        "NORMADIC PRIMARY SCHOOL WAREV",
        "KARARA MARKET SQUARE",
        "RCM PRIMARY SCHOOL IGYESE",
        "TOR - ITYOUGH",
        "RCM IKPONKO",
      ],
      "LIEV II": [
        "LGEA PRI SCH AHOBEE - WITHIN PREMISES",
        "TSE - UNYULA - IN FRONT OF THE COMPOUND",
        ...
        "AGULE IKUME - BESIDE AGULE IKUME'S COMPOUND",
        ...
        "ANNUNE MARKET SQUARE",
        "KPE ANYAM MARKET SQUARE",
        "SHIMO TECH. IKYOGEN",
        "LGEA PRIMARY SCHOOL NDAGH",
        "MANYI MARKET SQUARE",
      ],
      MBADURA: [
      ...
      "MBAGBA/MBAIKYAN": [
        ...
        "ANGER - UYOUGH - NEAR MARKET SQUARE",
        "ANUM IVOM, LGEA PRI. SCHOOL, ADZER",
        "LGEA PRI. SCHOOL, KUHE, SCHOOL PREMISES",
        "LGEA PRI. SCHOOL, UYOUGH, SCHOOL PREMISES",
        ...
        "MBAMBESE COMMUNITY",
        "ADZUA-IKYUR MARKET SQUARE",
        "LGEA PRIM. SCH. MBARUMUN",
        "ST PETER'S MBARUMUN",
        "ABUJA-MBAWEN MARKET",
      ],
      MBAIKYO: [
        ...
        "AMAHUNDU MARKET I - NEAR MARKET SQUARE",
        "AMAHUNDU MARKET II - CLOSE TO MARKET SQUARE",
        "UNONGO VILLAGE, CLOSE TO VILLAGE SQUARE",
        "LGEA SCHOOL, IKYUNA, SCHOOL PREMISES",
        "LGEA PRIM SCH JATO KUMBUR - WITHIN SCH PREMISES",
        "LGEA PRI. SCHOOL, ICHORON, SCHOOL PREMISES",
        "TSE MBAN COMPOUND - CLOSE TO THE COMPOUND",
        "NYIHEMBA, RCM PRI. SCHOOL, NYIHEMBA",
        "RCM PRIM SCH IHINDAN I - WITHIN THE PREMISES",
        "RCM PRIM SCH IHINDAN II - WITHIN THE PREMISES",
        "SAAVE, LGEA PRI. SCHOOL, SAAVE PREMISES",
        "UDEADEKU MARKET SQUARE",
        "LGEA SCHOOL, ADAM, SCHOOL PREMISES",
        "RCM. PRI. SCHOOL WENDE, SCHOOL PREMISES",
        "ANWASE MARKET, CLOSE TO MARKET SQUARE",
        "GSS, ANWASE, SCHOOL PREMISES",
        ...
        "AKPEN MARKET",
        "RCM PRIM. SCHOOL UCHAGH",
        "UJA VILLAGE",
        "LGEA PRIMARY SCHOOL MAAV ASAR",
        "MBAABO VILLAGE",
        "MAAV COMMUNITY SEC. SCHOOL",
        "LGEA PRIM. SCH. TYOKON",
        "NKST PRIMARY SCHOOL IGBA",
      ],
      MBAKETSA: [
        ...
        "LGEA PRIMARY SCH. KPENGWA",
        "OPEN SPACE, NEAR RCM PRI. SCH. MBAPE",
        "AJIO YAJI JUNCTION",
        "AJIO MARKET SQUARE",
      ],
      MENEV: [
        ...
        "AULE GBER - NEAR AULE GBER COMPOUND",
        ...
        "AKPE IMBUSU - NEAR IMBUSU COMPOUND",
        "LGEA PRI. SCHOOL, AYINDI, SCHOOL PREMISES",
        "KELEM, LGEA PRI. SCHOOL, KELEM PREMISES",
        "MTOM UTSEV, CLOSE TO VILLAGE SQUARE",
        "PRIMARY HEALTH CENTRE IGOM",
        "PRIMARY HEALTH CENTRE INJIOV",
        "NYAMKYUME MARKET",
        "PRIMARY HEALTH CENTRE ADAGI",
        "MBAKUR PRIMARY SCHOOL",
        "LGEA PRIMARY SCHOOL IVENGER",
      ],
      "TONDOV I": [
        ...
        "LIFE GATE SPACE",
        "LGEA PRI. SCH. MBAKUNU",
        "NKST PRIM. SCH. MTSWEN",
        "RCM PRIM SCH. TSEKWANGE",
        "UBE SECONDARY SCHOOL",
        "HIGH LEVEL IYON",
      ],
      "TONDOV II": [
        ...
        "NKST PRIM SCH GESA - SCHOOL PREMISES",
        "UNO MARKET - CLOSE TO MARKET SQUARE",
        "KOBOLO MARKET, LGEA PRI. SCHOOL, KOBOLO",
        "ADA MARKET II, BESIDE MARKET SQUARE",
        "TRAINING WORKSHOP KOTI",
        "NKST PRIMARY SCHOOL ADASO",
        "MUSA VILLAGE",
        "NKST PRIMARY SCHOOL YESE",
        "KAAMEM MARKET MBACHO",
        "KAAMEM MARKET MAGA",
        "NKST PRIMARY SCHOOL UKURA",
      ],
      USAR: [
        "PUUSU VILLAGE, NEAR VILLAGE PREMISES",
        "NKST. PRI. SCHOOL, IKURAN, SCHOOL PREMISES",
        "TYOGBENDA UCHI, BEFORE TYOGBENDA MARKET",
        "TSE ANKON - WITHIN TSE ANKON VILLAGE",
        "DZUNGWE VILLAGE SQUARE",
        ...
        "IKYUME VILLAGE",
        "Y - JUNCTION",
        "BESIDE AKO'S COMPOUND",
        "TSE AKON WITHIN TSE AKON VILLAGE",
      ],
      MBAYOO: [
        ...
        "GUDA - NEAR TSE ANIGO",
        "KYADO MARKET",
        "GABRIEL SUSWAM COTTAGE HOSPITAL",
        "COOPERATIVE OFFICE",
        "IKYAIOR MARKET",
        "TSE CHULA COMPOUND",
        "TSE HANIOR",
      ...
      YAAV: [
        ...
        "CHANKA MARKET SQUARE",
        "WANNUNE MARKET",
        "NKST PRIMARY SCHOOL MBALAHA",
        "FIELD HARVEST",
        "TINE NUNE",
        "KAAMEM MARKET",
        "MOTOR PARK JATO AKA",
        "LGEA TOWNSHIP PRIM. SCH. JATO AKA",
      ],
      MOON: [
        "ADANGE, BESIDE ADANGE COMPOUND",
        "WENDE, WENDE VILLAGE PREMISES",
        "MBANYON CLINIC - BESIDE THE CLINIC",
        "LGEA PRI. SCHOOL, ITYOUGH, SCHOOL PREMISES",
        "FISHIN MARKET, NEAR MARKET SQUARE",
        "LGEA PRIM SCH AGUCHENYI",
        "YANDE ATUM, CLOSE TO YANDE'S COMPOUND",
        "SHASE - BEFORE SHASE MARKET SQUARE",
      ...
      KUMAKWAGH: [
        ...
        "LGEA PRIM SCH AGURA I - SCH PREMISES",
        "LGEA PRI. SCHOOL, AGURA II, SCHOOL PREMISES",
        "TSE ATOROUGH, NEAR ATOROUGH COMPOUND",
        "MBEREV MARKET SQUARE",
        "NKST PRIMARY SCHOOL AGYAYO",
        "LGEA PRIM. SCHOOL MBAPEV",
        "MBAPEV IHYUNDU",
      ],
    },
    ...
    LOGO: {
      MBADYUL: [
        "RCM SCHOOL, GONDOZUA PLAY GROUND",
        "NKST SCHOOL GONDOZUA",
        "TSE JIIR VILLAGE SQUARE",
        "TORKUKWA VILLAGE SQUARE",
        "RCM PRI. SCHOOL ABEDA",
        "ABEDA MARKET SQUARE",
        "KAAKIGHIR VILLAGE SQUARE",
        "TIZA VILLAGE SQUARE",
        "AWANIMA VILLAGE SQUARE",
        "TARMENA VILLAGE SQUARE",
        "AKUSA VILLAGE SQUARE",
        "GONDOZUA MARKET SQUARE",
        "TSE AZEGE VILLAGE SQUARE",
      ],
      MBAGBER: [
        "RCM PRI. SCHOOL AKOMBO",
        "NKST PRI. SCHOOL, ANYIIN",
        "RCM PRI. SCHOOL ANYIIN",
        "LGEA PRI. SCHOOL, ANYIIN",
        "JINGA MARKET SQUARE",
        "IMADE NORTH (ANYIIN MARKET SQUARE)",
        "ANYIIN (MARKET SQUARE)",
        "LGEA PRI. SCHOOL, MCHIA",
        "RCM PRI. SCHOOL, TYOBAN",
        "NKST PRI. SCHOOL, KWAGH (KWAGH)",
        "LGEA SCHOOL, UIWEV",
        "ASEMA (VILLAGE SQUARE)",
        "TSE - IORBO (VILLAGE SQUARE)",
        "M.O.W CAMP",
        "NEAR ASHI POLY OPEN SPACE",
        "SUSWAM TINGIR VILLAGE SQUARE",
        "AMO HAMBE OPEN SPACE",
        "DIAKA VILLAGE SQUARE",
        "MCHIA MARKET SQUARE",
        "BURBWA VILLAGE SQUARE",
        "INJUUL VILLAGE SQUARE",
      ],
      MBATER: [
        "ASOM VILLAGE SQUARE",
        "TSE - KYANYON VILLAGE SQUARE",
        "RCM PRIMARY SCHOOL NEV",
        "LGEA PRIMARY SCHOOL ORBIAM",
        "TSE ABUUL (MARKET SQUARE)",
        "TSE - KYAUSU (VILLAGE SQUARE)",
        "NKST SCHOOL MBAASA",
        "RCM SCHOOL AGANYI",
        "UKANGE VILLAGE SQUARE",
        "AMATSO (VILLAGE SQUARE)",
        "LGEA SCHOOL KULEGWA",
        "IMANDE - ADEGA (VILLAGE SQUARE)",
        "AKINDE (VILLAGE SQUARE)",
        "SONGO VILLAGE SQUARE",
        "LGEA PRIMARY SCHOOL, JANDO",
        "KWAGHBEE VILLAGE SQUARE",
        "UGONDO COM. SEC. SCH. UGBA",
        "NEW CITY SETTLEMENT, NYAGH",
        "AGANDI VILLAGE SQUARE",
      ],
      MBAYAM: [
        "AKUME (VILLAGE SQUARE)",
        "UGBA MARKET SQUARE",
        "LGEA PRIMARY SCHOOL TSENGE",
        "MAKIR WORSHOP UGBA TOWN",
        "LOCAL GOVT CLINIC, UGBA.",
        "IGBALAGH VILLAGE SQUARE",
        "GWABO (VILLAGE SQUARE)",
        "LAAV (VILLAGE SQUARE)",
        "GWE (VILLAGE SQUARE)",
        "KAVE (VILLAGE SQUARE)",
        "TSE ANKON (VILLAGE SQUARE)",
        "TSE LUAMNYAM VILLAGE SQUARE",
        "LGEA PRIMARY SCHOOL, UGBA",
        "TSE IKYUIOR OPEN SPACE",
        "GOVT. COMP. SEC. SCH. UGBA",
        "TSE APEIKYULE OPEN SPACE",
        "USHISHA COMMUNITY",
        "GENERAL HOSPITAL, UGBA",
        "TSE JUMBU NEAR PRIM. SCHOOL",
        "TSE BAZE VILLAGE",
        "YAM MARKET, UGBA",
        "NEW GRA PUUBLIC CENTRE",
        "ANBUA VILLAGE SQUARE",
      ],
      MBAVUUR: [
        "LGEA SCHOOL ABEDA",
        "RCM SCHOOL ABEDA",
        "ABEDA MARKET SQUARE",
        "NKST SCHOOL ABEDA",
        "NKST SCHOOL ABEDA GARGUM",
        "ORWUA VILLAGE SQUARE",
        "NKST SCHOOL SHENGE",
        "RCM SCHOOL AGBAAM.",
        "NKST SCHOOL AGOV",
        "NKST IGBOUGHOUR",
        "ANGLICIAN SCHOOL INGBIAN",
        "TSE-PAGHER (VILLAGE SQUARE)",
        "RCM SCHOOL NYOOSU",
        "INDYER (VILLAGE SQUARE)",
        "TSE-WAV VILLAGE/TSE-WAV",
        "MBAVUUR COMM. SCH. ABEDA",
        "ABEDA OLD MARKET",
        "NKST PRIMARY SCHOOL, IGIRGI",
        "IKYAGH VILLAGE SQUARE",
      ],
      NENZEV: [
        "LGEA SCHOOL ITYOKYAA",
        "TSE-PAGHER (VILLAGE SQUARE)",
        "RCM SCHOOL DIBA",
        "RCM SCHOOL SHAKUME",
        "LGEA SCHOOL TSE-IGBON",
        "IHOOR (VILLAGE SQUARE)",
        "LGEA SCHOOL TSE-ALUOR",
        "IKOR MARKET SQUARE",
        "GBANYAM (VILLAGE SQUARE)",
        "AGAKU (VILLAGE SQUARE)",
        "TSE IKYEGH SETTLEMENT",
        "LGEA SCHOOL, MBAIFU",
        "LGEA PRIMARY SCHOOL, IKYOR",
      ],
      TONBO: [
        "NKST SCHOOL TYOUGBIHI",
        "GENYI (VILLAGE SQUARE)",
        "NKST SCHOOL ANUNGWA",
        "NKST SCHOOL GWATSE",
        "LGEA SCHOOL AMAN",
        "LGEA SCHOOL GBELEVE",
        "LGEA SCHOOL POOVULE",
        "LGEA PRIMARY SCHOOLSWAKI",
        "NKST SCHOOL AZEGE",
        "AZEGE MARKET SQUARE",
        "TATSE VILLAGE SQUARE",
        "LGEA PRIMARY SCHOOL UZER",
        "NKST SCHOOL IKYUEMEN",
        "AYILAMO MARKET SQUARE",
        "FOFI VILLAGE SQUARE",
        "NKST SCHOOL MBAKIGHIR",
        "LGEA PRIMARY SCHOOL KWUNGU",
        "LGEA PRIMARY SCHOOL, AUDU",
        "NKST SCHOOL ANAKAA",
        "ASUNTU MARKET SQUARE",
        "LEPROSY CLINIC NYAMKUMER",
        "RCM PRIMARY SCHOOL GETIM",
        "JIGAM SETTLEMENT",
        "LGEA PRIMARY SCHOOL, UGWE",
        "TSE BEGI MARKET SQUARE",
        "UZER MARKET SQUARE",
        "TOMBO COMM. SEC. SCH. IKYUNGWA",
      ],
      TURAN: [
        ...
        "YAGBA VILLAGE SQUARE",
        "DUSA COUNCIL HALL",
        "LGEA PRIMARY SCHOOL ABERAKA",
        "APAA MARKET SQUARE",
        "TSE TYOTSUGHUR PLAY GROUND",
        "TORTSOUGH PLAY GROUND",
        "LGEA PRIMARY SCHOOL, MBADUM",
      ],
      "UKEMBERGYA/ISWAREV": [
        "LGEA SCHOOL UOMBUR",
        "JOOTAR VILLAGE SQUARE",
        "LGEA SCHOOL AGBU",
        "TSE HWER VILLAGE SQUARE",
        "MNGBAKPA VILLAGE SQUARE",
        "CHEMBE VILLAGE SQUARE",
        "IORJA VILLAGE SQUARE",
        "NKST SCHOOL ADAWA",
        "LGEA SCHOOL UBAVER",
        "LGEA SCHOOL MONDO",
        "LGEA SCHOOL MOU",
        "LGEA SCHOOL MOU II (TSE MOU)",
        "IKURA VILLAGE SQUARE",
        "RCM TSE IGBUR",
        "LGEA PRI. SCH. SHAUSU",
        "LGEA PRIMARY SCHOOL, MEEME",
        "IORTSER MARKET SQUARE",
        "LGA PRIM. SCHOOL, IORZA",
        "GAKU VILLAGE SQUARE",
      ],
      YONOV: [
        "LGEA PRIMARY SCHOOL AKAA",
        "LGEA PRIMARY SCHOOL BAKA",
        "LGEA PRIMARY SCHOOL TSE ATETAN",
        "LGEA SCHOOL TSE UBEN",
        "LGEA PRIMARY SCHOOL YATIEV",
        "LGEA PRIMARY SCHOOL AKAAYAR",
        "ZANZAN VILLAGE SQUARE",
        "NKST PRIMARY SCHOOL IORSHAGHER",
        "RCM PRIMARY SCHOOL ORALU",
        "WEGHGBA VILLAGE SQUARE",
        "TSE - AGERE VILLAGE SQUARE",
        "ABIEM - GBENDE",
        "KAJIVA VILLAGE SQUARE",
        "AGBANA VILLAGE SQUARE",
        "AGASAAR MARKET SQUARE",
        "TSE IBOM VILLAGE SQUARE",
      ],
    },

    MAKURDI: {
      AGAN: [
        "TSE IKULA - TSE IKULA VILLAGE SQUARE",
      ...
      "AKPAN/WADATA": [
        ...
        "NULGE STATE SECRETARIATE, DAVID MARK BYE PASS",
        "IORBEE - NEAR AGELAGBA - NO. 9 BENIN STREET",
        "BABA NEAR AKURE - NAKA STREET, NEAR POLLY CLINIC",
        ...
        "ABU AGATU HOUSE II - 13 MARKET ROAD WADATA",
        "LGEA SCHOOL DEMEKPE - WITHIN SCHOOL PREMISES",
        "D' DIVISION - FRONT OF NUJ HOUSE",
        "HAPPY HOME - FRONT OF HAPPY HOME SCHOOL",
        "BEHIND CEMETERY - ADIKPO STREET",
        ...
        "GOMBE STREET II - ALONG GOMBE STREET NO. 9",
        "NEAR LAWAL IMAN - IN FRONT OF NO. 29, KADUNA STREET",
        "ABDUL KANDE - IKEJA STREET",
        "WADATA WARD - PORT-HARCOURT STREET",
        "NEAR ZAMGWA AGBEDE HOUSE - RICE MILL",
        "NEAR BABATYO HOUSE RICE MILL",
        "NEAR NONGO HOUSE EGUME STREET",
        "FRONT OF WADATA GUEST HOUSE",
        "KADUNA STREET JUNCTION BY BENUE CRESCENT WADATA",
        "OFF ZAKI BIAM STREET - NEAR DONKO HOUSE",
        "NEAR AGAGBE HOUSE BY NKST WADATA",
        "NEAR ISHOR HOUSE BY THE COLVET COMMUNITY SEC. SCH. ROAD",
        "NKST SHARP BENDING, NEAR GOD'SWILL PLAZA",
        "BESIDE ASSEMBLIES OF GOD CHURCH BENUE CRESCENT",
        "OPPOSITE FAITH HILL DEMEKPE",
        "BIDA STREET - NEAR AYILA KUR HOUSE",
        "TSE GBA UTAAN STREET - NEAR SWEET 52",
        "BIDA ABAAGU II - NEAR AMAAKAVEN HOUSE",
        "BENIN STREET - NEAR MBATYEREV HOUSE",
        "BENIN STREET - NEAR YARO ANDURA HOUSE",
        "NAKA STREET, NEAR CHIYAM HOUSE",
        "NAKA ROAD - NEAR WANGER HOUSE",
        "ADIKPO STREET NEAR MAMA TERSAR HOUSE",
        "OPPOSITE EUNICE RESORT - NAKA ROAD",
        "JOSEPH TION IYO STREET - NEAR JOSEPH TION IYO HOUSE",
        "BEHIND NUJ HOUSE, OPPOSITE NKST ATI",
        "LG QUARTERS - BY MODERN MARKET JUNCTION",
        "OUR LADY PRIMARY SCHOOL ANKPA QUARTERS",
        "INSIDE RESTORATION PARK-FORMER ROC PARK",
        "FRONT OF JOS ELECTRICITY DISTRIBUTION NAKA ROAD",
        "FRONT OF JERRY AGBER HOUSE - BEM HOTEL ROAD",
        "NEAR ZAKI AGBER HOUSE-AGBER VILLAGE",
        "OPPOSITE BOLEK FILLING STATION-DAVID MARK BYE PASS",
        "Y JUNCTION BY DAVID MARK BYE PASS",
        "NEAR AZAKA HOUSE BEHIND HAPPY HOME",
        "BEHIND CEMETERY II - NO 123",
      ],
      BAR: [
        "LGEA SCHOOL, TIONSHA - WITHIN THE SCHOOL",
        "NYITI VILLAGE. NYITI VILLAGE SQUARE NAKA",
        ...
        "NEAR TYOKUA AKYA HOUSE",
        "TSE AUDU BY BORE HOLE",
        "NEAR TAKOR LABE HOUSE, BEHIND PRISON",
        "BY CARM WUDOM COLLEGE JUNCTION",
        "AJOGA ST. LINUS MISSION GBETSE",
        "APOSTOLIC SEC. SCHOOL ADEKE NEAR IORBEE",
        "WELFARE QUARTERS JUNCTION",
        "NEAR FRANCA SHISHA BAR, BEHIND TINY TOT",
        "KANSHIO PRIMARY SCHOOL II",
        "OPPOSITE KANSHIO MARKET",
        "LAKE CHAD HOTEL BESIDE",
        "VICTORIA ATOROUGH STREET BESIDE DUNAMIS",
        "BESIDE KIDS AUTHORITY SCHOOL",
        "HOTEL LUCIA, BESIDE",
        "BEHIND CIVIL SERVICE COMMISSION",
        "RADIO BENUE ENTRANCE",
        "ACHUSA MARKET",
        "NEAR ST. MARY CATHOLIC SONGU ACHUSA",
        "MTN MASK NEAR AKOMBO SAMSON HOUSE",
        "MZOUGH KAVE NEAR GLORY OF HIS MAJESTY SEC. SCH.",
      ],
      "CENTRAL/SOUTH MISSION": [
        ...
        "HOLY GHOST/FED MEDICAL CENTRE OPP THE CHURCH PRIMARY SCHOOL",
        ...
        "NEAR EFCC OFFICE",
        "JEDC OPPOSITE FSP LOBI QTRS",
        "NEAR CHRISTIAN PILGRIMAGE BOARD",
        "URBAN DEVT. BOARD KASSIM IBRAHIM WAY",
        "IDS JUNCTION OPEN SPACE KASSIM IBRAHIM",
        "ST. CATHERINE PRI. SCHOOL",
        "BESIDE HIGH COURT",
        "ALELE VILLAGE",
        "FRONT OF GOVT. COLLEGE",
        "NO 40 IKEJA STREET BEHIND ALL SAINT PRI. SCH.",
        "FRONT OF NIGER OPTICAL",
        "IBADAN STREET NEAR METHODIST CHURCH",
        "OPPOSITE EKAN CHURCH BARRACK ROAD",
        "NO 25 BARRACK ROAD NEAR OKEY SHOP",
        "NO 35 BARRACK ROAD",
        "NO 3 MICHEAL WANDU STREET",
        "FRONT OF LGEA PRI. SCHOOL, OPP. GOVT GIRLS",
        "OPPOSITE IZALLA MOSQUE",
        "NO 1 ALIH AKILU ROAD NEAR OBISEN HOUSE",
        "NO 47 NIGER CRESCENT NEAR MAMMAN BAUCHI",
        "OPPOSITE ALH. TANKO HOUSE",
        "NEAR ALH. TIJANI MAI-TURAKE",
        "NO 4 ABBA STREET NEAR MUSA PLATEAU HOUSE",
        "NO 6 BENUE CRESCENT NEAR MANDAR HOUSE",
        "OPPOSITE NO 15 BENUE CRESCENT",
        "NEAR POWER HOUSE BAUCHI STREET",
        "SOKOTO STREET NEAR TRANSFORMER",
        "NEAR SARKIN KADO BAUCHI STREET",
        "NO 22 SOKOTO STRT NEAR MALLAM KYARIS HOUSE",
        "NO 22 NEAR BABA DANHINA HOUSE",
        "NO 60 KANO STREET NEAR BENUE CRESCENT",
      ],
      "CLERKS/MARKETS": [
        ...
        "PROTOCOL GOVERNMENT HOUSE",
        "NEAR MUSAFAHA SCANNING CENTRE KWARARAFA",
        "FRONT OF FSP CLINIC KWARARAFA",
        "NEW TINDA HOUSE",
        "NEAR MALLAM NDA HOUSE BY PRISON",
        "NEAR HARUNA ADEMU HOUSE BAUCHI STREET",
        "BEHIND ALL-ST. CATHEDRAL LAGOS STREET",
      ],
      FIIDI: [
        ...
        "IORHON AND IORHON VILLAGE. OFF ABUKING SHULWA",
        ...
        "IGBA PETER, IGBA PETER BEHIND LOWER BENUE",
        ...
        "NEPA DISTRICT OFFICE II",
        "DIVINE COMMAND SCHOOL",
        "OPEN SPACE BESIDE SLYKAN FUEL STATION",
        "DIVINE FAVOUR SCHOOL",
        "OPEN SPACE OPPOSITE SANCTUARY HOPE FOR ALL INTL.",
        "CBN LAYOUT",
        "LOGO PRIMARY SCHOOL II",
        "TRUST RESORT OPEN SPACE",
        "YOUTH CENTRE",
        "OWNER OCCUPIER PHASE I",
        "YINA JUNCTION II",
        "AKPEGH UNIT",
        "VAATIA COLLEGE",
        "WAILOMAYO PRIMARY SCHOOL",
        "AKPEHE MARKET",
        "SAVIOUR MODEL SCHOOL",
        "MTN MASK",
        "DYEGE MEMORIAL SCHOOL",
        "UNIQUE NUR/PRI SCHOOL",
        "NEW WURUKUM MARKET 2",
        "OPEN SPACE OPP. HOLY TRINITY ANGLICAN CHURCH",
        "COCA-COLA DEPOT",
        "LGEA PRIMARY SCHOOL GAADI",
        "NIGERIAN BREWERY",
        "ST. DOMINIC PRIMARY SCHOOL",
        "NEAR NNPC FUEL STATION",
        "GYADO VILLA EXTENSION",
        "JUDGES QUARTERS EXTENSION",
        "USUR VILLAGE",
        "AKPEREKAA - MU VILLAGE",
        "NAF BASE TSE - GBAWER",
        "RCM PRI. SCHOOL AGBAKYOR",
        "TSE-AVER AIRPORT MARKET",
        "TSE AWUNA FIIDI",
        "TSE APIE (NAF BASE)",
        "TSE AJON VILLAGE",
        ...
        "EPIDEMIOLOGY UNIT",
        "ZOOLOGICAL GARDEN",
        "POLITICAL SCIENCE PARK",
        "OPPOSITE BSU FIRST GATE",
        "COLLEGE OF HEALTH SCIENCE",
        "BOLEK FUEL STATION",
        "PEVER AGENA",
        "LADY VICTORIA ACADEMY",
        "UKPO-UDAM MARKET",
        "CHRIST THE KING NUR/PRI SCHOOL",
        "E DIVISION AKPEHE",
        "ST. ALOYSIOUS CATHOLIC CHURCH OPEN SPACE",
        "TSE - TAMEN",
        "TSE - AKPI",
        "TSE AYU",
        "TSE NYON",
      ...
      "MODERN MARKET": [
        ...
        "BEHIND 'D' DIVISION - TERNAMDOO PRI. SCHOOL",
        ...
        "OPEN SPACE OPPOSITE LUCKY STAR NUR/PRI SCHOOL, CECILIA HEMBE STREET (LOW COST)",
        "OPEN SPACE NEAR AGELAGBA HOUSE OF WORSHIP CHURCH",
        "OPEN SPACE OPPOSITE EMMANUEL NUR/PRI SCH. LOW COST 1ST GATE NAKA ROAD",
        "OPEN SPACE - BESIDE ST. JAMES CATHOLIC CHURCH, FEDERAL LOW COST NAKA ROAD",
        "OPEN SPACE NEAR IBER AKO'S COMPOUND NAKA ROAD",
        "OPEN SPACE - IN FRONT OF MULTIPURPOSE ACADEMY PREMISES, SAM ORUM STREET",
        "OPEN SPACE, NEAR ADELI COMPOUND NEAR EL-SHADAI SCH. YONGOIKO ANJEMBE STREET",
        "ATSER ORCHIR ROAD - NEAR ORCHIR VILLAGE OPEN SPACE",
        "OPEN SPACE, BESIDE HE REIGNS NUR/PRI SCHOOL BAM-BAM",
        "OPEN SPACE ITAR KUSUGH BESIDE GLORY WORLD CLASS COLLEGE, NEAR ST. PETERS CATHOLIC CHURCH",
        "AWAITYO MARKET SQUARE CLOSE TO NOMADIC PRI. SCHOOL INJAHA",
        "OPEN SPACE AKILE GBE, BEHIND BOMA NUR/PRI SCHOOL",
        "OPEN SPACE, FRONT OF PAUL EMPTION ACADEMY SCHOOL DEMEKPE",
        "OPEN SPACE SIMON AONDONA STREET, AMADU COMAS ROAD (MAKURDI)",
        "OPEN SPACE NO. 18 DOOYUM BAKERY STREET, DEMEKPE",
      ],
      "NORTH BANK I": [
        "TILLEY GYADO COLLEGE, SCHOOL FRONTAGE",
        "FEDERAL LOW COST - FEDERAL LOW COST, LAFIA ROAD",
        "ECWA SEC SCHOOL FED LOW COST, OLD LAFIA ROAD.",
        ...
        "PETER TARKENDE II - 40 OLD LAFIA ROAD",
        "V.I.O. I - VIO GROUND",
        "V.I.O. II - VIO GROUND",
        ...
        "ORSHIO SETTLEMENT BY FADAMA III",
        "BEHIND ST. JAMES, NEAR CEFN CHURCH",
        "NEAR NKST CHURCH JAMU",
        "TILLEY GYADO COLLEGE, SCHOOL FRONTAGE II",
        "OPEN SPACE OPPOSITE C / J LINE JUNCTION FED. LOW COST",
        "PLAY GROUND, ALONG FIRST GATE, FEDERAL LOW COST",
        "OPEN SPACE, SECOND GATE ENTRANCE, FEDERAL LOW COST",
        "YAGBA VILLAGE - YAGBA VILLAGE SQUARE II",
        "BEHIND ST. MICHEAL'S CATHOLIC CHURCH",
        "BESIDE OKIKI HOTEL",
        "STAFF QUARTERS NEAR V.C. LODGE",
        "NEAR FRACTURE HOSPITAL",
        "SAONDO UNUM OPEN SPACE 1ST AVENUE",
        "WALU OPEN SPACE",
        "NEAR TIMOTHY TIMOR HOUSE",
        "ANWUNA OPEN SPACE JOR FADA",
        "72 BARRACKS JUNCTION",
        "NEAR UPAA HOUSE",
        "NEAR AKOMBO HOUSE",
        "NEAR ZAKI GBANDE HOUSE",
        "AYIHE OPEN SPACE",
        "FIDELIX BUR OPEN SPACE",
        "BAWA MARKET SQUARE",
        "NEAR ORNGUGA ADA BEHIND GENERAL HOSPITAL",
      ],
      "NORTH BANK II": [
        "SCHOOL OF REM. STD. JUNCTION - AT THE JUNCTION",
        "TIMBER SHED - NEAR OLD BRIDGE",
        "HUDCO QUARTERS I - OPPOSITE COURT 5",
        "HUDCO QTRS II PLAYING GROUND",
        ...
        "NEAR ALH GOMBE II 52, UDEI STREET OLD LAFIA ROAD.",
        ...
        "OPEN SPACE, NEAR MALLAM SANI MOSQUE",
        "OPEN SPACE, OFF YOGBO STREET NO. 30",
        "NEAR DANKEJI",
        "OPEN SPACE, IGUMALE STREET",
        "OPEN SPACE, BEHINDI GAND HOTEL",
        "OPEN SPACE, BEHIND CEMENTRY",
        "OPEN SPACE, OPPOSITE CHRISTIAN CENTRE",
        "OPEN SPACE OPPOSITE U.E.C. CHURCH",
        "OPEN SPACE, BEHIND AGB MOSQUE",
        "NEAR SPACE BESIDE MAI JAMAA' MOSQUE",
        "OPEN SPACE, IN FRONT OF AGB MOSQUE",
        "OPEN SPACE NEAR ALH. KAWU MOSQUE",
      ],
      ...
      WAILOWAYO: [
        ...
        "WURUKUM MARKET (OLD) BEHIND LIBRARY COMPLEX",
        ...
        "GOVERNMENT MODEL (GATE) SCHOOL",
        "PADOPAS HARMONY SCHOOL II",
        "KASSY BEACH",
        "PALM TREE SPOT II",
        "OPEN SPACE OPPOSITE CITY BAY PARK",
        "ST. THERESA'S PRIMARY SCHOOL II",
        "BIRS OFFICE GATE",
        "OG WINNERS PLAZA",
        "LOBI LEASING COMPANY",
        "OLD RICE MILL MARKET SQUARE",
        "OPEN SPACE BESIDE IZALA MOSQUE",
        "AIR FORCE BUS - STOP",
        "LGEA PRIMARY SCHOOL WURUKUM II",
        "ST. PETERS PRIVATE SCHOOL",
        "ANGWAN JUKU",
        "AGOYGO",
        "NURUL HAYA SCHOOL",
        "ANGWAN JUKUN MARKET SQUARE",
        "EPUTEPA",
        "ASHIGO",
        "FAMILY DOLLAR",
        "RAILWAY CLUB",
        "Y-JUNCTION - ABINSE STREET",
        "SATOS PRESS II",
        "VOICE OF NIGERIA",
        "APPARITION",
        "ATLANTA HOTEL II",
        ...
        "BURUKUTU WAALAWA",
        "TARKA FOUNDATION II",
        "STATE SECRETARIAT II",
        "PAULINE MAKA CENTRE",
        "NYIMAN PILLA II",
        "PATRICK ITYOHEGH BOULIVARD GATE",
        "NUJ PEN COLLEGE PREMISES",
        "DAVCEE GARDEN",
        "DOCTOR'S QUARTERS",
        "BEHIND TSB OPEN SPACE",
        "NIGERIA VOICE II",
        "B-DIVISION",
      ],
    },
    ...
    OBI: {
      ...
      "ADUM WEST": [
        ...
        "PLAY GROUND-OPIRIKWU ADUM",
        "PLAYGROUND ETUMU ANYO",
        "PLAYGROUND OKWUBI",
        "PLAYGROUND OWI OKUMAYE",
        "PLAYGROUND IKPON NYIRE",
      ],
      IKWOKWU: [
        "PRIMARY SCHOOL - ADIGBE/ADODO",
        "PRIMARY SCHOOL - UGBODOM I",
        "MARKET SQUARE - UGBODOM II",
        "PLAY GROUND - UDEGI",
        "PLAY GROUND - UKPINO/UGBOGWU",
        "PLAY GROUND - AKWUNDA",
        "PLAYGROUND ADODO ABONU",
        "PLAYGRD SEC SCH. UGBODOM",
        "MARKET SQ UGBODOM",
        "PLAYGROUND OJIYA UDEGI 2",
        "OJWO PLAYGROUND",
      ],
      IRABI: [
        "PLAY GROUND - ADEGA",
        "PLAY GROUND - OBIJAGO I",
        "PLAY GROUND - OGEGE",
        "PLAY GROUND - OBIJAGO II",
        "PLAYGROUND OJIJE",
        "PLAYGROUND ADEGA IRABI",
      ],
      ITOGO: [
        "PLAY GROUND - ITOGO IPINU",
        "PLAY GROUND - EKINGO",
        "PLAY GROUND - IGBEGI I",
        "PLAY GROUND - IGBEGI II",
        "PLAY GROUND - UBEKE",
        "PILOT PRIMARY SCHOOL - IYAHO",
        "PLAY GROUND - IYAHO II",
        "PLAY GROUND - EBONG",
        "PLAY GROUND - UKPUTE",
        "ADEDE EDU PLAYGROUND",
        "PLAYGROUND ONYAGEDE",
        "PLAYGROUND OGBIJI",
        "OGBIJI PLAYGROUND",
        "OPP ASSEMBLY OF GOD UGBOGWU",
      ],
      OBARIKE: [
        ...
        "PLAYGROUND OBARIKE CENTRE",
        "PLAYGROUND CAMP OKPUPU",
        "PLAYGROUND IRABI EDU",
        "MARKET SQUARE IHIOKWU",
        "ST PATRICK SCH IRABI 11",
        "PLAYGROUND IJANKE",
      ],
      OBEKO: [
        "PLAY GROUND - IWAGOGO",
        "PLAY GROUND - UMAPIA",
        "PLAY GROUND-ADUGODU/ EDDI I",
        "PLAY GROUND-ADUGODU/ EDDI II",
        "PLAY GROUND - ABODE",
        "PLAY GROUND - UWOBE",
        "PLAY GROUND-IWAGOGO II",
        "LGEA PRY SCH.ED11 ITAFOR",
        "OPP. ADUGODU AGRIC CENTRE",
        "UWOBE OHIO OBEKO",
        "UMAPIA ED11 OBEKO",
      ],
      ODIAPA: [
      ...
      OGORE: [
        "ABIKAM/ABOTUTU PLAY GROUND",
        "OHEUHE OJEGBE PLAY GROUND",
        "OYE OBA MARKET SQUARE",
        "PLAYGROUND BETHSIDA",
        "LGEA PRIMARY SCHOOL OHUEHE",
        "PHC OJEGBE",
        "PLAYGROUND OBODO",
      ],
      OKPOKWU: [
        "ECHORI I - PLAY GROUND",
        "ECHORI II - PLAY GROUND",
        "ITAKPA IHIO MARKET SQUARE I",
        "ITAKPA PRIMARY SCHOOL - II",
        "OKPOKWU OPP. ST. MARKS CHURCH - I",
        "OKPOKWU PLAY GROUND - II",
        "MARKET SQUARE ANYEJE",
        "LGEA PRIMARY SCHOOL OBINE",
        "PLAYGROUND ITAKPA",
        "PLAYGROUND UGBOGWU",
        "UBE OKPOKWU",
        "OKPOKWU EVENING MARKET",
      ],
      OKWUTUNGBE: [
        "PRIMARY SCHOOL - OHUEHE/IGBONO",
        "MARKET SQURE OJWO OKWUTUNGBE",
        ...
        "PRIMARY SCHOOL IGWE",
        "PLAYGROUND ITUMU",
        "PLAYGROUND OBA AGBARU",
      ],
      ORIHI: [
        "PLAY GROUND - OHUMA",
        "PLAY GROUND - OYINYI",
        "PLAY GROUND - IKIRIHIE",
        "PLAY GROUND - AHUEYE",
    ...
    OGBADIBO: {
      "AI-OODO I": [
        ...
        "	OGLEWU ADUM PLAYGROUND",
        "OHUDU AIKWU PLAYGROUND",
        "OLEMPE ORIDO PLAYGROUND",
      ],
      "AI-OODO II": [
      ...
      "AI-OONO II": [
        ...
        "COURT/OLABIGBA PLAYGROUND",
        "UGBODU PRIMARY SCHOOL",
      ],
      "AI-OONO III": [
        ...
        "OBU OLD BRANCH - EDE MARKET SQUARE I",
        "OBU OLD BRANCH - EDE MARKET SQUARE II",
        "UGO PLAYGROUND",
        "LGEA PRI. SCHOOL OBUI",
        "AGADAGBA PLAYGROUND",
        "AI-OKEWU PLAYGROUND",
      ],
      "EHAJE I": [
      ...
      OLACHAGBAHA: [
        ...
        "ENYIKWO - CHIN PLAYGROUND",
        "IPISU PLAYGROUND",
        "ALOHI - ALOMA JUNCTION OLACHAGBAHA",
      ],
      "OROKAM I": [
        ...
        "OSUPI - OKPORO PLAYGROUND",
        "AKPA, ADUPI PLAYGROUND",
      ],
      "OROKAM II": [
    ...
    OJU: {
      ...
      IBILLA: [
        ...
        "ANDIBILLA - OPEN SPACE",
        "IBILLA - ALUKPO - OPEN SPACE",
        "UCHENYUM - OPEN SPACE",
      ...
      IDELLE: [
        ...
        "UBELE/ONYAGEDE/OYILO/OWO O/S",
        "IFEGA OPEN SPACE",
        "OGEGE II P/SCHOOL",
        "OKONCHE P/SCHOOL",
        "EZZA ANWU",
        "NDI NWANKWO OPEN SPACE",
      ],
      IYECHE: [
      ...
      OJU: [
        ...
        "OJU IPINU PLAYGROUND",
        "COLLEGE OF IMMA. CONCEPTION",
        "AKRABA/OYOBA",
        "L.G.E.A P/SCH UTABIJI",
        "PRI. HEALTH CENTER OGA OLUWA",
      ],
      OKPOKPO: [
      ...
      OWO: [
        ...
        "OMUA I - PLAY GROUND",
        "OMUA II - PLAY GROUND",
        "OJIYA OKPOKPO IYE-IGBE",
        "UWANGO PLAYGROUND",
        "OHOHO P/SCHOOL IHIOBILA",
        "ADUMM MARKET SQUARE",
      ...
      "UKPA/AINU ETTE": [
        ...
        "IHIEJWO MARKET SQUARE 2",
        "OBA OLORI OPEN SPACE",
        "UGBOGWU OPEN SPACE",
        "UMODA PRI. HEALTH CARE",
        "OJIYA PLAYGROUNG",
        "ANYOGBE OPEN SPACE",
        "OBOTU/EKINGO PLAYGROUND",
        "IHIO MARKET SQUARE",
        "UJE ADALA P/SCHOOL",
        "OJIYA PLAYGROUND",
        "L.G.E.A P/SCH IKACHI",
        "EJE-OPILA OPEN SPACE",
        "UWA MARKET SQUARE",
        "IMA AINU P/SCHOOL",
        "APWUIMA OPEN SPACE",
        "UKPUTE HEALTH CENTER",
      ],
    },

    OHIMINI: {
      AGADAGBA: [
        "CLASS ROOM/OHUGBINE PRIMARY SCHOOL",
      ...
      EHATOKPE: [
        ...
        "OPEN SPACE/OLA-AME",
        "EHATOKPE OPEN SPACE",
        "UGENE-EHAJE TOWN HALL",
        "IPU-KWABA PLAY GROUND",
      ],
      IDEKPA: [
        ...
        "OPEN SPACE/OLAIGBECHE",
        "MARKET SQUARE IDEKPA",
        "BESIDE LGA SECRETARIAT",
        "IPIGA/UKPOBI OPEN SPACE",
      ],
      OCHOBO: [
        ...
        "LGEA PRIM. SCH. OCHOBO/AJEGBA.",
        "HAMDALA-IPOLE, OCHOBO",
        "OCHOBO PLAY GROUND",
      ],
      "OGLEWU EHAJE": [
        ...
        "OPEN SPACE/ANMODA",
        "LGEA PRIM. SCH. AWULEMA",
        "AGBOKE OPEN SPACE",
        "OPEN SPACE, PRIM. HEALTH CLINIC, ATLO.",
        "OJANO-IJAMI OPEN SPACE",
        "LGEA PRIM. SCH. ATAKPA",
      ],
      "OGLEWU ICHO": [
        "PRIMARY SCHOOL ANWULE",
        ...
        "CEFN, ONYEPA.",
        "METHODIST HIGH SCHOOL OKETE OKPIKWU",
        "LGEA PRIM. SCH. OMUTELE",
        "ANWULE TOWN HALL/OPEN SPACE.",
      ],
      "ONYAGEDE-EHAJE(ALLE)": [
        ...
        "OPEN SPACE/UNMONOMI",
        "IKPOKE/OGANDE PLAY GROUND",
        "OPEN SPACE ABAKPA CENTRAL",
        "UNMONOMI PLAY GROUND",
      ],
      "ONYAGEDE-ICHO(OGOLI)": [
    ...
    OKPOKWU: {
      AMEJO: [
        ...
        "OGBEHE OGBODO OPEN SPACE",
        "IJEGE EXPRESS",
        "OKPUDO OLANYEGA OPEN SPACE",
        "ONYAYI PRIMARY SCHOOL",
        "IJAJI OPEN SPACE - OGENE",
        "ODUDA OPEN SPACE",
      ],
      EKE: [
        ...
        "OLENGBECHO OPEN SPACE - OLENGBECHO",
        ...
        "EKE MARKET OPEN SPACE",
        "AI-ADOGBO PLAY GROUND",
        "OLEMGBECHO CAMP",
      ],
      "ICHAMA II": [
      ...
      OJIG0: [
        ...
        "OJAPO MARKET SQUARE II",
        "OJIGO TOWN PLAYGROUND II",
      ],
      OJOGA: [
      ...
      OKONOBO: [
        ...
        "IGBANDLA OPEN SPACE, OKPAFIE",
        "OMADEWU PRIMARY SCHOOL",
        "LGEA PRIMARY SCHOOL, OLLO",
        "EBOYA AI-AKOR PLAYGROUND - OKONOBO",
        "UJAH PLAYGROUND, OKONOBO",
      ],
      "OKPALE/INGLE": [
        ...
        "AI-OJOGWU PLAYGROUND",
        "OLALEJE PLAYGROUND, OLAICHE",
        "AKPITODO PLAYGROUND, IPOYA",
      ],
      "OKPOGA CENTRAL": [
        ...
        "EHI-CHO UGWU",
        "ABOSSA CAMP DUNWADA",
        "GENERAL HOSPITAL, OKPOGA",
        "ST. MARY HOSPITAL, UGWU",
        "DISPENSARY UMEGWU",
      ],
      "OKPOGA NORTH": [
        ...
        "ONO-ALIDOGODO MARKET SQUARE",
        "LGEA PRIMARY SCHOOL, OGBAGA",
        "OTAMPE/OGWUCHE APARI",
        "ANYIRIGWAFU, OKPUDU",
      ],
      "OKPOGA SOUTH": [
      ...
      UGBOKOLO: [
        ...
        "AI-OBIDA PLAYGROUND II",
        "EFFA OPEN SPACE, EFFA",
        "OKUNGAGA/LGEA PRIMARY SCHOOL",
        "BEN POLY GARDEN II",
        "ODESSASA MARKET SQUARE III",
      ],
    },

    OTUKPO: {
      "ADOKA-ICHO": [
        "OJINEBE PRIMARY SCHOOL COMPOUND",
        "OKPAFLO PLAY GROUND I, PLAY GROUND",
        "OKPAFLO PLAY GROUND II, PLAY GROUND",
        "OKPAFLO OPEN SPACE I, OPEN SPACE",
        "OGOWU VILLAGE SQUARE",
        ...
        "OJAKPAMA OPEN SPACE",
        "UGODUMU RCM OPEN SPACE",
        "OLOKE PRIMARY SCH. COMPOUND",
        "FRONT OF EJIGA MEMORIAL COLLEGE EJINYA",
        "OKPAFLO OPEN SPACE II ODEJE-ABO",
        "OTADA PRIMARY SCHOOL COMPOUND",
        "EFU II OPEN SPACE FRONT OF NGBEDE CLINIC",
        "EFU I OPEN SPACE OPP. IHOTU GUEST INN",
        "AKUNU OKPANEHE OPEN SPACE",
        "UDABI III OPEN SPACE",
        "ABACHE OPEN SPACE BEFORE BRIDGE",
        "IPIGWEBE IV OPEN SPACE BEHIND MHS",
        "IPIGWEBE III OPEN SPACE",
        "UGA EHAJE OPEN SPACE",
        "OGBAGO PRIMARY SCHOOL COMPOUND",
      ],
      "ADOKA-IHAJE": [
        ...
        "UNITY COLLEGE OF EDUCATION GATE",
        "LGEA PRIMARY SCHOOL AUNE",
      ],
      ALLAN: [
        ...
        "OJOMA AKOPA PLAYGROUND, PLAYGROUND",
      ...
      EWULO: [
        ...
        "BESIDE UPU COMMUNITY HALL UNDER A TREE",
        "PERFECT AVENUE JUNCTION UPU RD. OPEN SPACE",
        "NEAR DEEPER LIFE CHURCH OTADA ICHO",
        "2 AMEH ODOH AVENUE OPEN SPACE",
        "OPP. 10 OTIA G OPEN SPACE",
        "IGBANOMAJE PLAYGROUND NEAR PUBLIC WELL",
        "FRONT OF ST. AUGUSTINE PRIMARY SCHOOL",
        "EDIKWU PUBLIC WELL OPEN SPACE",
        "IKOBI II NEAR METHODIST CHURCH",
        "ASA II LGEA PRIMARY SCHOOL II",
        "UGBOLOJO OPEN SPACE",
      ],
      OKETE: [
        ...
        "LGEA PRIMARY SCHOOL OTUKPO ICHO",
        "OTUKPO ICHO PLAYGROUND II",
        "OTUKPO ICHO III OPEN SPACE",
      ],
      OTOBI: [
      ...
      "OTUPO TOWN CENTRAL": [
        ...
        "MOSES ENENCHES STREET (OPEN SPACE)",
        "OCHIDOMA SQUARE SHADE II",
        "BEN ONAJI/ECHONO STR. JUNCTION OPEN SPACE",
        "OPPOSITE 17 OKPAIMO STR. OPEN SPACE",
        "OPPOSITE 74 OKWO-OMENKA STR. OPEN SPACE",
        "BELOVED AVENUE/OCHIGBO LAYOUT JUNCTION OPEN SPACE",
        "OPPOSITE 20 SUNDAY OKOPI STREET NEW HAVEN",
        "BESIDE 12 UMOGIDI STR. SABON GARI",
        "OCHE STR./OPAHA RD JUNCTION OPEN SPACE",
        "BESIDE 129 OTUKPA STR. OPEN SPACE",
        "OGBADIBO STR. BESIDE TRANSFORMER",
        "27 OCHALEFU STR. EUPI UNDER MANGO TREE",
        "9 RAJI RASAKI AVENUE PIPELINE OPEN SPACE",
        "DAVID STONE/RAJI RASAKI AVE. JUNCTION OPEN SPACE",
        "35 IJAMI ROAD OPEN SPACE",
        "TRAFFIC JUNCTION OPP. MAIN MARKET OPEN SPACE",
      ],
      "OTUPO TOWN EAST": [
        ...
        "OPEN SPACE (NEAR NO 7 JC OBANDE STREET)",
        "ST MARY PRIMARY SCHOOL III",
        "OPP. 23 COL. ISHAKU STREET BABYLON OPEN SPACE",
        "OPP. NAPRI OFFICE OLENA OPEN SPACE",
        "OPP. 12 LUMUMBA STREET OPEN SPACE",
        "OPP. 10 ULAYI STREET OPEN SPACE",
        "10 ENUGU STREET OPEN SPACE",
        "BEHIND WESLEY HIGH SCH. BY TRANSFORMER OPEN SPACE",
        "OLENA OPEN SPACE OPP. GEORGE OBE JUNCTION",
        "8TH MAN QUARTERS AFTER EVENT CENTER UNDER A TREE",
        "ASA ROUNDABOUT OPEN SPACE",
        "FRONT OF FORMER SDP SECRETARIAT ASA I",
        "OBAGANYA II OPEN SPACE",
        "LGEA PRIMARY SCHOOL OGOME",
        "OKPOBEKA OPEN SPACE",
        "10 EGWA AVE GRA UNDER A TREE",
        "BEHIND POLICE BARRACKS GRA OPEN SPACE",
      ],
      "OTUPO TOWN WEST": [
        ...
        "NOCROSS PRIMARY SCHOOL II",
        "OPP. NO 35 JERICHO RD. OPEN SPACE UNDER A TREE",
        "FRONT OF NO 1 JESUS STREET OPP. MT. ZION ZONE HB",
        "FRONT OF NO 44 IGEDE STREET OPEN SPACE",
        "78 SUNDAY ONYILO/AKPA STR. JUNCTION II",
        "OPP. 13 SUNDAY ONYILO STREET II OPEN SPACE",
        "OPEN SPACE OPPOSITE 14 FREEDOM A STREET",
        "FRONT OF 86 EBIJE STREET OPEN SPACE",
        "OPP. ST. FRANCIS SECONDARY. SCH. GATE OPEN SPACE",
        "LGEA PRIMARY SCHOOL EUPI II",
        "OGBE OBANDE STR BY AGBARA STR. JUNCTION OPEN SPACE",
        "NEAR UJOR MEMORIAL SEC. SCH. OPEN SPACE",
      ],
      "UGBOJU-EHAJE": [
        "OGOBIA PRIMARY SCHOOL I, SCHOOL COMPOUND",
        "OGOBIA APRIMARY SCHOOL II, SCHOOL COMPOUND",
        "OGOBIA WEST I, OPEN SPACE",
        "ONDO IPEPE PRIMARY SCH. SCH COMP",
        "EMICHI PRIMARY SCH, SCHOOL COMPOUND",
        "AKPACHI PRIMARY SCHOOL I, SCHOOL COMPOUND",
        "IGARUWA VILLAGE SQURE",
        "OLOGLI VILLAGE SQUARE",
        "OBO/OJOMO VILLAGE SQUARE",
        "OGOBIA WEST II, OPEN SPACE",
        "AKPACHI PRIMARY SCHOOL II, OPEN SPACE",
        "IPITABA OPEN SPACE",
        "OLADIJI OPEN SPACE",
        "OGOBIA MARKET SQUARE",
        "IPUEMO OPEN SPACE BEHIND POST OFFICE",
        "OYEE OGOBIA OPEN SPACE",
        "OGOBIA CAMP OPEN SPACE NEAR ST. ANDREW SEC. SCH.",
      ],
      "UGBOJU-ICHO": [
        ...
        "ENANJILA, OPEN SPACE",
        "OFILOKO - OPEN SPACE",
        "IFETE ANYEBE VILLAGE SQUARE",
        "IPOLO-ICHO LGEA PRIMARY SCHOOL",
        "AI-OBEKA VILLAGE SQUARE OGOLI",
        "OGOLI CENTER OPEN SPACE",
      ],
      "UGBOJU-OTAHE": [
        "JERICHO, OPEN SPACE",
        "OKOTO PRIMARY SCHOOL, OPEN SPACE",
        "A'OKWU PRIMARY SCHOOL, OPEN SPACE",
        "UDUABI PRIMARY SCHOOL I, SCH COMP",
        "UDUABI PRIMARY SCHOOL II, SCH COMP",
        ...
        "IBAJI PRIMARY SCHOOL OPEN SPACE",
        "AIOGOH OPEN SPACE OPP. VICTORY METHODIST CHURCH",
        "EFEYI IBOLO OPEN SPACE",
        "OKWUDU OPEN SPACE II OPP. ADAMUS HOUSE",
      ],
    },

    TARKA: {
      "MAAJIR AKAA": [
        "LGEA PRIMARY SCHOOL ATSEKE",
        "CHERRY WOOD MARKET SQUARE",
        "COL NENGE LGEA PRIMARY SCHOOL",
        "LGEA PRIMARY SCHOOL PIPE LINE",
        "LGEA PRIMARY SCHOOL, UKU/LGEA PRIMARY SCHOOL, UKU",
        "NKST PRI SCH ASO",
        "LGEA PRI SCH PIPE LINE II",
        "KORTSAV PLAY GROUND",
      ],
      MBAAYO: [
        "LGEA PRIMARY SCHOOL AKENDE",
        "ABOHO MARKET SQUARE I/ABOHO",
        "ABOHO MARKET SQUARE II/ABOHO",
        "LGEA PRI SCH SOOYON",
        "LGEA PRI SCH TYINDIKURA",
      ],
      "MBACHAVER IKYONDO": [
        "AKPA AGUDO MARKET SQUARE/AKPA AGUDO MARKET SQUARE",
        "TSE UKONKO MARKET SQUARE I - TSE UKONKO MARKET SQUARE",
        "TSE UKONKO MARKET SQUARE II - TSE UKONKO MARKET SQUARE",
        "LGEA PRIMARY SCHOOL UKYO",
        "YAVE MARKET SQUARE",
        "LGEA PRIMARY SCHOOL, ASUKUNYA/LGEA PRIMARY SCHOOL, ASUKUNYA",
        "GEVER INGBIAN MARKET SQUARE",
        ...
        "LGEA PRIMARY SCHOOL UKYOUGH",
        "LGEA PRIMARY SCHOOL CHIA",
        "LGEA PRI SCH AKPA AGUDO",
        "LGEA PRI SCH GBIHI VEMBE",
        "ORAFEREGH MKT SQ",
        "LGEA PRI SCH IWOIKPUR",
        "LGEA PRI SCH IKPA LOUGH",
      ],
      MBAIGBA: [
        "LGEA PRIMARY SCHOOL, TIAM/LGEA PRIMARY SCHOOL, TIA",
        "LGEA PRIMARY SCHOOL, SENDE/LGEA PRIMARY SCHOOL, SENDE",
        "ATEGBA MARKET SQUARE",
      ...
      MBAIKYAA: [
        ...
        "LGEA PRIMARY SCHOOL, KONIKYAR - LGEA PRIMARY SCH, KONIKYAR",
        "KAAMEM KENDEV MKT SQ",
        "LGEA PRI SCH MCHILA",
        "MCHILA MKT SQ",
      ],
      "MBAIKYO/MBAYIA": [
        "LGEA PRIMARY SCHOOL, SALEM I/LGEA PRIMARY SCHOOL SALEN I",
        "LGEA PRIMARY SCHOOL, SALEN II/LGAE PRIMARY SCHOOL SALEEM II",
        "AKOODO MARKET SQUARE/AKOODO MARKET SQUARE",
        "LGEA PRIMARY SCHOOL, BUTER/LGEA PRIMARY SCHOOL, BUTER",
        "LGEA PRIMARY SCHOO IORKYASE I",
        "LGEA PRIMARY SCHOO IORKYASE II",
        ...
        "RCM PRIMARY SCHOOL, ANNUNE",
        "LGEA PRIMARY SCHOOL, ANNUNE/LGEA PRIMARY SCHOOL, ANNUNE",
        "NKST. PRIMARY SCHOOL, ANNUNE/NKST PRIMARY SCHOOL, ANNUNE",
        "LGEA PRIMARY SCHOOL KUNGWA",
        "GOVT. SEC. SCHOOL ANUNNE",
        "UKENAKYA MKT SQ",
        "LGEA PRI SCH ANCHIHA",
        "RCM PRI SCH ANUNNE II",
        "MBAKOR COMM SC. SCH ANUNNE I",
        "MBAKOR COMM SC. SCH ANUNNE II",
        "ABUDU",
        "VETINARY CLINIC ICHEGH",
        "ZAHEMEN ACADEMY KOBO",
        "WATER BOARD ANUNNE",
      ],
      MBAKWAKEM: [
      ...
      SHITILE: [
        ...
        "UKYAVER PLAY GROUND",
        "LGEA PRI SCH IMINA II",
        "TIORTYU MKT SQ II",
      ],
      TONGOV: [
        "LGEA PRIMARY SCHOOL ATIGHIR",
    ...
    UKUM: {
      ATERAYANGE: [
        ...
        "TSE INGBIAN VILLAGE - TSE INGBIAN VILLAGE OPEN SPACE",
      ...
      AZENDESHI: [
        ...
        "ABENGA LGEA SCHOOL/SCHOOL COMPOUND",
        "TSE-NYAJO VILLAGE/TSE-NYAJO OPEN SPACE",
        "ATSAAN VILLAGE MARKET SQUARE",
        "CHITO POLICE STATION",
        "ORIFAM VILLAGE SQUARE",
        "LGEA PRIMARY SCHOOL ANAKA",
      ],
      BORIKYO: [
        ...
        "RCM AKUUNYA",
        "UKUM LOCAL GOVT. SECRETARIATE",
      ],
      ITYULUV: [
        "AGBOR VILLAGE - SCHOOL COMPOUND",
        "AJANTA VILLAGE - TSE AJANTA VILLAGE OPEN SPACE",
        "APEGBAN VILLAGE - APEGBAN VILLAGE SETTLEMENT OPEN SPACE",
      ...
      KENDEV: [
        ...
        "JIME INDEYER VILLAGE - JIME INDYER VILLAGE SETTLEMENT OPEN SPACE",
      ...
      LUMBUV: [
        ...
        "ALABAR VILLAGE MARKET",
        "ASAN VILLAGE",
        "ANYA VILLAGE",
        "LGEA PRIMARY SCHOOL AGBUM",
        "NKST PRIMARY SCHOOL AKAANYA",
        "LGEA PRIMARY SCHOOL ABADO",
      ],
      MBAITIAN: [
      ...
      MBAYENGE: [
        ...
        "TSE IKYOHO - TSE IKYOHO VILLAGE",
        "LGEA SCHOOL DAUDA - SCHOOL PREMISES",
        "GAZA MEMORIAL SEC. SCHOOL",
        "LGEA MELABU PRIMARY SCHOOL",
      ],
      MBAZUN: [
        ...
        "LGEA SCHOOL CHIATA - SCHOOL PREMISES",
        "KERGA DIO/KERGA DIO VILLAGE OPEN SPACE",
        "AKAA AKUNDO/RCM. SCHOOL AKUNDO",
        "TSE-AYIAGA OPEN SPACE/TSE AYIAGBA OPEN SPACE",
        "TSE BURYA VILLAGE",
        "ANGLICAN SEC. SCHOOL KYADO",
        "KYADO NEW YAM MARKET",
        "MBATEREM COMM. SEC. SCHOOL KYADO",
        "LGEA SCHOOL SHANGE",
        "TSE AGBAVIR VILLAGE",
        "UKPEN VILLAGE SQUARE",
        "AKAAER VILLAGE",
      ],
      TSAAV: [
        ...
        "LGEA SCHOOL, AFIA - SCHOOL COMPOUND",
        ...
        "IGBONGON VILLAGE",
        "AVEN VILLAGE",
        "AFIA VILLAGE MOTOR PARK",
        "RCM PRIMARY SCHOOL AFIA",
        "UCHA COMM. SEC. SCHOOL AFIA",
      ],
      UGBAAM: [
      ...
      UYAM: [
        ...
        "TSE DUGWER - TSE DUGWER VILLAGE SETTLEMENT OPEN SPACE",
        ...
        "ZAKI BIAM EAST BESIDE NKST",
        "NKST UZO B",
        "UNGWAN KUNGIYA ZAKI BIAM",
        "IGBO HALL ZAKI BIAM",
        "NKST ZAKI BIAM WEST",
        "RCM TYOGA VILLAGE",
        "ST. ANTHONYS SECONDARY SCHOOL ZAKI BIAM",
        "DIVINE MERCY SEC. SCHOOL ZAKI BIAM",
        "SHOVIKA COMPREHENSIVE SEC. SCH. ZAKI BIAM",
      ],
    },
    ...
    USHONGO: {
      ATIRKYESE: [
        ...
        "RCM SCH. AYEV ATOZA 1",
        "RCM. SCHOOL HINDAN",
        "RCM SCHOOL AYEV ATOZA II",
        "L.G.E.A. SCHOOL, BOOR II",
        "AJAVER MARKET SQUARE",
        "JOO-GBENDA MARKET SQUARE",
        "TSE BUA FRUITS MARKETS SQUARE",
        "LGEA PRIMARY SCHOOL ANGWE",
        "LGEA PRIMARY SCHOOL UGEE",
      ],
      IKOV: [
        "UDE MARKET SQUARE",
        ...
        "LGEA SCHOOL BILAJA",
        "LGEA SCH. ICHAVER",
        "HIITOM ORBIAM VILL. SQR. I",
        "HIITOM ORBIAM VILL. SQR. II",
        "LGEA SCHOOL UKANDE",
        "GEMA VILLAGE SQUARE",
        "FADA, MARKET SQUARE",
        "ATEE MARKET SQUARE",
        ...
        "LGEA SCHOOL MANOR",
        "NKST SEC. SCH. FAAJI",
        "LGEA SCH. HIITOM ORBIAM",
        "IGUNGU MKT SQUARE",
        "AKYA MKT SQUARE",
      ],
      LESSEL: [
        "LESSEL, GARRAGE I",
        "DEFUNCT NRC SECRETARIAT",
        ...
        "CHIA MKT SQUARE",
        "UPPER AREA COURT",
        "KINGS AND QUEENS NURS. PRI. SCH.",
        "COLLEGE OF HEALTH TECH.",
        "MBAAGWA COMMUNITY SCH. LESSEL",
        "MATERNAL & CHILD HEALTH CLINIC AKPENGE",
      ...
      MBAAKA: [
        ...
        "WAJIR, MARKET SQUARE",
        "RCM. SCHOOL, ATIMENYA",
        "MBAYOUGSHA VILL. SQUARE",
        "ANYWAKPE VILLAGE SQUARE",
        "BER AGBUM VILLAGE SQUARE",
        "LGEA SCH. TSEGHEM",
        "TSEGHEM MAR. SQUARE",
        "TSE-FATE VILL. SQ. II",
        "BAGU MKT SQUARE",
        "AMELANGU MARKET SQUARE",
        "LGEA SCHOOL SENDEUN",
        "LGEA SCHOOL SHIRGA",
        "TSE HUNDU MARKET SQUARE",
      ],
      MBAANYAM: [
        "ORBAN MARKET SQUARE I",
        "UCHDOMCU SCHOOL OF HEALTH TECH",
        "KAMEM JUNCTION",
        "RCM. SCHOOL, ABUUL",
        "REM SCHOOL WAAPERA",
        "MDSS WAAPERA I",
        ...
        "LGEA SCHOOL, SHAWON",
        "RCM. SCHOOL, AKPERA",
        "ANGLICAN SCH. IGBAUKE",
        "ORBAN MARKET SQ. II",
        "MDSS WAAPERA II",
        "NAJIME MARKET SQUARE",
        "SOON MARKET SQUARE",
        "LAN MARKET SQUARE",
        "AKURE ADUKU",
      ],
      MBAAWE: [
        "DOUGH AKUNDU MAR. SQU.",
        "RCM SCH. JORNOR (ABA YOL)",
        "LGEA SCHOOL JOR-NOR",
      ...
      MBAGBA: [
        ...
        "TSEE-ADUM VILLAGE SQUARE",
        "TSUMBA MARKET SQUARE",
        "LGEA SCH. TSUMBA",
        "ATSER KAASHIMA VILL. SQU.",
        "RCM SCH. YAMTYO",
        "LGEA SCH. ALUMUKU",
        "YESE MARKET SQUARE",
        "NKST PRIMARY SCHOOL GBE",
        "QUEENS AND KINGS NUR. PRI. SCH. IUSA",
        "ACHIATAR VILLAGE SQUARE",
        "FOUR WAY MARKET SQUARE",
        "CHEBE MARKET SQUARE",
        "GYAR MARKET SQUARE",
        "APUSU VILL. SQUARE",
        "ICHIGH KI IORLIAM MARKET SQUARE",
        "LGEA PRI. SCH. TULUGH MBAGBA",
        "YONGO MKT SQUARE",
      ],
      MBAGWAZA: [
        ...
        "JOOYAR MARKET SQUARE",
        "MBAIKYAA PROGRESSIVE SEC. SCH.",
        "CHADO MARKET SQUARE",
        "IMANDE BOSHI VILL. SQUARE",
        "TCE-GESA VILL. SQUARE",
        "BETHEL MARKET SQUARE",
      ],
      ...
      MBAYEGH: [
        ...
        "NKST SCHOOL, USHONGO",
        "NURSERY AND PRIMARY SCHOOL USE",
        "TSE AGWA VILLAGE SQUARE",
        "LGEA SCHOOL, UKE-KPENGA",
        "ANAREGH MARKET SQUARE",
        "RCM SCHOOL, ITYOUGH",
        "LGEA SCH. YINA",
        "LGEA SCHOOL MBAHILAR",
        "POST OFFICE USHONG",
        "NKST. SCHOOL, ADAGI",
        "GSS USHONGO",
        ...
        "RCM. SCHOOL, KPEREGH",
        "RCM SCHOOL SHIRSHIMA",
        "GBATSE MARKET SQUARE",
        "RCM. SCHOOL, IORHUNA",
        "NKST SCHOOL KPOR",
        "KPOR MARKET SQUARE",
        "ANIWANGE MARKET SQUARE",
        "USHONGO TOWNSHIP HALL",
      ],
      UTANGE: [
        ...
        "JINDI MARKET SQUARE",
        "TSE GAVAR VILLAGE SQUARE",
        "TSE-IVO VILLAGE SQUARE",
        "Y-MARKET SQUARE",
    ...
    VANDEIKYA: {
      MBADEDE: [
        ...
        "OPEN SPACE NEAR AVUVE COMP.",
        "MARKET SQUARE NGEGHEE",
        "OPEN SPACE NEAR NKST CHURCH UKA",
        "RCM SCHOOL ADE",
        "OPEN SPACE TSE AMOKAHA GBA",
        "OPEN SPACE NEAR NKST NOR",
        "OPEN SPACE RCM SCHOOL ORKUMA",
        "LGEA PRI. SCH. TOR-TIV",
        "MARKET SQUARE IOROR",
        "MARKET SQUARE ALAKALI",
        "OPEN SPACE OPP. ALIAS COMP.",
        "OPEN SPACE OPP.ST. WINIFRED CATH. CHURCH",
        "RCM PRIMARY SCHOOL, ANZA",
        "OPEN SPACE NEAR ST. DOMINIC YUHWE",
        "OPEN SPACE NEAR RCM TSECHOR",
        "NKST PRI. SCH. IHUGH",
      ],
      MBATYOUGH: [
        "LGEA SCHOOL, TSAR I",
        ...
        "OPEN SPACE NEAR CTR. FOR DIS.",
        "SHAAR AGEGE MARKET SQUARE",
        "OPEN SPACE NEAR ICT CENTRE",
        "GOVERNMENT SEC. SCHOOL TSAR",
        "OPEN SPACE NEAR RCM SCHOOL TIOONYO",
      ],
      MBAGBAM: [
        ...
        "MBAGBAM COUNCIL HALL",
      ],
      MBAGBERA: [
        "LGEA SCHOOL, DAMKOR",
        "MARKET SQUARE - JAPE",
        "NKST. PRIMARY SCHOOL - NAA",
        "OPEN SPACE TSE AKUME",
        "LGEA SCHOOL - ANSHOR",
        "NEAR COMP. KUEGH",
        ...
        "FEAKPO COUNCIL HALL PREMISES",
        "OPEN SPACE NEAR NKST CHURCH, KUMBUR",
        "ABEGE MEMORIAL SEC. SCHOOL",
        "NKST PRIMARY SCHOOL MKER",
        "RCM CHURCH AGBURUGBU",
      ],
      MBAJOR: [
        "OPEN SPACE DURA BUA (NEAR RCM TYOHON)",
      ...
      MBAKAANGE: [
        ...
        "OPEN SPACE IN FRONT OF TOR JECHIRA'S PALACE",
        "OPEN SPACE ANANDE IKPA COMP.",
        "OPEN SPACE TSE LUGA",
        "OPEN SPACE TSE IDYU",
        "OPEN SPACE NKST ANYAMHUR",
        "OPEN SPACE TSE TYOBAN",
      ],
      MBAKYAHA: [
        "NKST. SCHOOL - UGBA",
        "RCM SCHOOL - AKUSE",
        ...
        "OPEN SPACE NEAR TYOSULA'S COMP",
        ...
        "OPEN SPACE NEAR RCM CHURCH ACHIR",
        "OPEN SPACE NEAR KOTI OLD POLICE STN.",
      ],
      MBAYONGO: [
        ...
        "NEAR COMP. - TSE DAAGU",
        "OPEN SPACE TSE AGUDO",
        "MARKET SQUARE GERI GBANGEE",
        "LGEA SCHOOL ADAMGBE",
        "OPEN SPACE TSE SAMAKA",
        "VEMBE BRANCH",
      ],
      NINGEV: [
        ...
        "OPEN SPACE NEAR RIVER MICHILE",
        "NEAR BOKON COMM. HALL",
        "OPEN SPACE NEAR TSE TOR",
        "OPEN SPACE NEAR GYAA ABUM",
        "OPEN SPACE NEAR NKST KYAAVE",
      ],
      TSAMBE: [
        ...
        "NKST. SCHOOL PREMISES - ADEIYONGO II",
        ...
        "OPEN SPACE NEAR AWUA AUGUSTINE COMP.",
      ],
      "VANDEIKYA TOWNSHIP": [
        "FEDERAL GOVERNMENT COLLEGE PREMISES - VANDEIKYA",
        "NEAR COMP. TSE BECHA",
        "BASIC HEALTH CENTRE, CLINIC PREMISES",
        "OPEN SPACE NEAR IGBATIM ALIBO'S COMP.",
        "NEAR COMP. OPEN SPACE NYOR GAADI",
        "OPEN SPACE OPP. NYOR GAADIS COMP.",
        "OPEN SPACE OPP. CHRIST THE KING PARISH",
        ...
        "OPEN SPACE NEAR IHO'S COMP.",
        "RCM SCHOOL, PREMISES AGBO",
        "DIVISIONAL AGRIC OFFICE PREMISES",
        "NKST SCHOOL PREMISES - TOR I",
        "NKST. SCHOOL PREMISES - TOR II",
        "OPPOSITE YAAYA'S CAMP. YAAYA",
        "GBATSE INTERNATIONAL SEC. SCH. V/KYA",
        "AGBO MARKET SQUARE (OPEN SPACE)",
        "OPEN SPACE NEAR BERI'S COMP.",
        "OPEN SPACE SKILL ACQUISITION CENTRE AWAJIR",
        "OPEN SPACE NEAR ABARIS COMP.",
        "OPEN SPACE NEAR IGBA COMP.",
        "OPEN SPACE OPPOSITE LG SECRETARIAT",
        "OPEN SPACE NEAR (DEC) MICROFINANCE OFFICE",
        "OPEN SPACE HAUSA QTRS V/KYA",
        "OPEN SPACE NEAR ANGLICAN CHURCH",
        "OPEN SPACE BEHIND LGEA PRI. SCH. TOR",
      ],
      MBANYUMANGBAGH: [
        "MARKET SQUARE - BETSE",
        "MARKET SQUARE - DAGBA",
        ...
        "NUA NUR & PRI. SCHOOL",
        "MARKET SQUARE IBI",
        "LGEA SCHOOL UBA USHE",
        "GBETAR MARKET SQUARE",
      ],
    },
  };
  ...
  $("#ward").on("changed.bs.select", function () {
    ...
    const pollingUnitDropdown = $("#polling_unit");
